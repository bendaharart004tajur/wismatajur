    ...
    const baseColumns: ColumnDef<Iuran>[] = [
        {
            ...
            cell: ({ row }) => <div className="pl-4 font-medium">{row.getValue('nama')}</div>
        },
        {
            accessorKey: 'bulan',
            header: 'Periode',
        ...
        },
        {
            ...
            cell: ({ row }) => {
                ...
                return <div><Badge variant="secondary">{metode}</Badge></div>;
            }
        },
        {
            accessorKey: 'status',
            ...
            cell: ({ row }) => {
                ...
                return <div className="hidden sm:table-cell"><Badge variant={status === 'Lunas' ? 'default' : 'destructive'}>{status}</Badge></div>;
            }
        },
        {
