...
import { addPengeluaranAction } from '@/app/actions/pengeluaran-actions';
...
export function AddPengeluaranDialog({ onSuccess }: { onSuccess: () => void }) {
  const { user } = useAuth();
  ...
  async function onSubmit(values: PengeluaranFormValues) {
    ...
    try {
      ...
      const result = await addPengeluaranAction(user.peran, user.nama, dataToSend);
            ...
            <div className="grid gap-4 py-4">
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        ...
                        <FormControl>
                            <Input placeholder="Contoh: Pembelian bola lampu untuk pos satpam" {...field} />
                        </FormControl>
                        <FormMessage />
                        </FormItem>
                    )}
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        ...
                        <FormControl>
                            <Input placeholder="https://link.ke/gambar.jpg" {...field} />
                        </FormControl>
                        <FormMessage />
                        </FormItem>
                    )}
